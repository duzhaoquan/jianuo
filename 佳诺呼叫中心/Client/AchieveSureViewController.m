...
@interface AchieveSureViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation AchieveSureViewController
...
-(void)getdata{
    __weak AchieveSureViewController *weakSelf = self;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(nonnull NSIndexPath *)indexPath{
    TaskModel *model = _faultList[indexPath.row];
    AchieveSureDetailViewController *achieveSureDetailViewController = [[AchieveSureDetailViewController alloc]init];
    achieveSureDetailViewController.taskmodel = model;
    [self.navigationController pushViewController:achieveSureDetailViewController animated:YES];
