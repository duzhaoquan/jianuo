...
@interface TaskProcessingDetailVC ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
...
@implementation TaskProcessingDetailVC
...
-(void)setupbutton{
    ...
    [button setTitle:@"现场处理" forState:UIControlStateNormal];
...
-(void)getdata{
    __weak TaskProcessingDetailVC *weakSelf = self;
...
-(void)buttonDidClick{
    ...
    NSString *URL = [NSString stringWithFormat:@"%@%@",kHost,@"index.php/api/api/task_maintenance"];
    [manager POST:URL parameters:params progress:^(NSProgress * _Nonnull uploadProgress) {
