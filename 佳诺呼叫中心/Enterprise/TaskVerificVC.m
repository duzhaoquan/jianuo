...
//    NSString *nsh = NSHomeDirectory() ;
//    NSLog(@"nsh%@",nsh);
}
-(void)getdata{
    __weak TaskVerificVC *weakSelf = self;
...
{
    TaskVerificDetailVC *taskVerificDetail = [[TaskVerificDetailVC alloc]init];
    taskVerificDetail.model = _taskList[indexPath.row];
    
    [self.navigationController pushViewController:taskVerificDetail animated:YES];
}
